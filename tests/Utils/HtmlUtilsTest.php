...
class HtmlUtilsTest extends bootstrap
{
    ...
    public function testDelDivErrorWithMultipleClasses()
    {
        $html = '<div class="info error">Has error class</div>';
        $result = del_div_error($html);

        $this->assertStringNotContainsString('Has error class', $result);
    }
